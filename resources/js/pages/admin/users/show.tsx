            ...
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <div className="rounded-xl bg-[#160b22]/80 border border-white/5 overflow-hidden">
                    ...
                    <div className={`h-32 bg-gradient-to-r ${getStatusColor(user.status)} relative`}>
                        <div className="absolute inset-0 bg-[url('/bg-pattern.svg')]"></div>
                    </div>
                    ...
                    <div className="px-8 pb-8">
                        ...
                        <div className="relative flex items-end justify-between">
                            <div className="flex items-end gap-6">
                                <div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-[#7f13ec] to-[#ff2a6d] flex items-center justify-center border-4 border-[#160b22] shadow-xl z-20 relative -mt-16">
