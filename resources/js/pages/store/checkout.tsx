...
export default function Checkout({ items, subtotal, tax, total }: CheckoutProps) {
                                    ...
                                    {paymentMethods.map((method) => (
                                        ...
                                        >
                                            <span className={`material-symbols-outlined text-2xl ${
                                                data.payment_method === method.id ? 'text-[#7f13ec]' : 'text-gray-400'
                                            }`}>
                                                {method.icon}
                                            </span>
                                ...
                                <div className="space-y-4 mb-6 max-h-64 overflow-y-auto no-scrollbar">
                                    {items.map((item) => (
                                        <div key={item.id} className="flex gap-3">
                                            ...
                                            <p className="text-white text-sm">{formatPrice(item.subtotal)}</p>
                                        </div>
                                    ))}
                                </div>
